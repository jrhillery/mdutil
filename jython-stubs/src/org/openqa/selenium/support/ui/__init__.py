...
class ExpectedConditions(object):
    # source:jar:file:/~/Documents/Prog/selenium-java-4.21.0/selenium-support-4.21.0.jar!/org/openqa/selenium/support/ui/ExpectedConditions.class
...
class WebDriverWait(object):
    # source:jar:file:/~/Documents/Prog/selenium-java-4.21.0/selenium-support-4.21.0.jar!/org/openqa/selenium/support/ui/WebDriverWait.class
