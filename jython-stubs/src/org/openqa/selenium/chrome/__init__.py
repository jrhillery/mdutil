...
class ChromeDriver(object):
    # source:jar:file:/~/Documents/Prog/selenium-java-4.18.1/selenium-chrome-driver-4.18.1.jar!/org/openqa/selenium/chrome/ChromeDriver.class
    IS_CHROMIUM_BROWSER = None

    class When(object):
        # source:jar:file:/~/Documents/Prog/selenium-java-4.18.1/selenium-remote-driver-4.18.1.jar!/org/openqa/selenium/remote/RemoteWebDriver$When.class
        AFTER = None
        BEFORE = None
        EXCEPTION = None
...
class ChromeDriverService(object):
    # source:jar:file:/~/Documents/Prog/selenium-java-4.18.1/selenium-chrome-driver-4.18.1.jar!/org/openqa/selenium/chrome/ChromeDriverService.class
    ...
    class Builder(object):
        # source:jar:file:/~/Documents/Prog/selenium-java-4.18.1/selenium-chrome-driver-4.18.1.jar!/org/openqa/selenium/chrome/ChromeDriverService$Builder.class
...
class ChromeOptions(object):
    # source:jar:file:/~/Documents/Prog/selenium-java-4.18.1/selenium-chrome-driver-4.18.1.jar!/org/openqa/selenium/chrome/ChromeOptions.class
    CAPABILITY = None
    LOGGING_PREFS = None
